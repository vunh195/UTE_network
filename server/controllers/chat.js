...
exports.getChats = (req, res) => {
  ...
  Chat.find(
    {
      $or: [
        { "reciever._id": recieverId, "sender._id": senderId },
        { "sender._id": recieverId, "reciever._id": senderId },
      ],
    },
    (err, chats) => {
      if (err || !chats) {
...
exports.chatList = async (req, res) => {
  const senderId = req.params.senderId;
  let chatList1 = await Chat.distinct("reciever._id", {
    "sender._id": senderId,
  });
  let chatList2 = await Chat.distinct("sender._id", {
    "reciever._id": senderId,
  });
