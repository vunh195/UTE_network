...
class Chat extends Component {
  ...
  async componentDidMount() {
    ...
    socket.on("message", async (newChat) => {
      ...
      //await this.getChats()
      if (
        newChat.sender._id === recieverId ||
        newChat.sender._id === senderId
      ) {
  ...
  render() {
    const { chatList, messages, reciever, sender, showPicker, loading } =
      this.state;
    return (
            ...
            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
              <div className="card card-chat m-0">
                <div className="row no-gutters">
                  ...
                  <div
                    className="col-xl-8 col-lg-8 col-md-8 col-sm-9 col-9"
                    style={{
                  ...
                  >
                    <div className="selected-user">
                      <span>
                        To: <span className="name">{reciever.name}</span>
                      </span>
                    </div>
                    <ScrollToBottom className="chat-container">
                      <div>
                        <ul className="chat-box chatContainerScroll">
                          {messages.map((chat, i) => this.renderChat(chat, i))}
                      ...
                      <form onSubmit={this.sendMessage}>
                        <div className="form-group mt-5">
                          <div className="input-group">
                            ...
                            <button
                              type="submit"
                              className="btn btn-raised-secondary btn-primary pull-right"
                            >
