...
const Menu = (props) => (
    ...
    >
        ...
        <div className="navbar-brand" >
            <img src="https://youth.hcmute.edu.vn/assets/img/logo/logo_UTE_HSV_DTN.svg" alt=''></img>
            <a  style={{ color: "#3E4551", fontFamily: "Candara" , fontWeight: 'bold', marginLeft:10}} href="/">
            myHCMUTE</a>
        </div>
            ...
            {isAuthenticated() && (
                <>
                    ...
                    <div className="dropdown">
                        <button style={{color: "#3E4551"}} className="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
